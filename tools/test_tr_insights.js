...
const empty = compute([], "");
ok("empty input → no cases, zeroed KPIs", empty.cases.length === 0 && empty.kpis.systemic === 0 && empty.kpis.stale === 0);
...
vm.runInContext("TI = _fixtureRows; currentRoleUser = { name: 'T', role: 'admin', subsystem: '' };", ctx);
